    ...
    MultiProvider(
      providers: [
        ChangeNotifierProvider(
            create: (_) =>
                BudgetViewModel(categoryRepository)..loadCategories()),
        ChangeNotifierProvider(
            create: (_) =>
                ExpenseViewModel(expenseRepository)..loadExpenses()),
        ChangeNotifierProvider(
            create: (_) =>
                AccountsViewModel(accountRepository)..loadAccounts()),
        ChangeNotifierProvider(
            create: (_) =>
                SavingsViewModel(savingsRepository)..loadSavings()),
        ChangeNotifierProvider(create: (_) => AuthViewModel()),
      ],
      child: const MyBudgetProApp(),
    ),
  );
}

class MyBudgetProApp extends StatelessWidget {
  const MyBudgetProApp({super.key});
